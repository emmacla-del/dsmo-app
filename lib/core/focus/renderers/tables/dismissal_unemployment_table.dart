...
class DismissalUnemploymentTable extends StatelessWidget {
  ...
  const DismissalUnemploymentTable({
    super.key,
    required this.field,
  ...
  static const _types = ['dismissal', 'technical_unemployment', 'total'];
  ...
  Widget build(BuildContext context) {
    ...
    final renderSpec = SpreadsheetCompiler.compileDismissalUnemployment(
      id: field.id,
      matrix: matrix,
    );
