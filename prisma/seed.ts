...
const minefopServices = [
    ...
    // MINISTRE (Art. 1)
    // ══════════════════════════════════════════════════════════════════════════
    { code: 'MIN', category: 'CENTRALE' as ServiceCategory, level: 0, parentCode: null, name: 'Ministre de l\'Emploi et de la Formation Professionnelle', acronym: 'MIN', roleMapping: 'CENTRAL' as UserRole, requiresRegion: false, requiresDepartment: false, orderIndex: 0 },

    // ══════════════════════════════════════════════════════════════════════════
    // Services under Minister's authority (Art. 2)
    // ══════════════════════════════════════════════════════════════════════════
    { code: 'SP', category: 'CENTRALE' as ServiceCategory, level: 1, parentCode: 'MIN', name: 'Secrétariat Particulier', acronym: 'SP', roleMapping: 'CENTRAL' as UserRole, requiresRegion: false, requiresDepartment: false, orderIndex: 1 },
    { code: 'CT', category: 'CENTRALE' as ServiceCategory, level: 1, parentCode: 'MIN', name: 'Conseillers Techniques', acronym: 'CT', roleMapping: 'CENTRAL' as UserRole, requiresRegion: false, requiresDepartment: false, orderIndex: 2 },
    { code: 'IGS', category: 'CENTRALE' as ServiceCategory, level: 1, parentCode: 'MIN', name: 'Inspection Générale des Services', acronym: 'IGS', roleMapping: 'CENTRAL' as UserRole, requiresRegion: false, requiresDepartment: false, orderIndex: 3 },
    { code: 'IGF', category: 'CENTRALE' as ServiceCategory, level: 1, parentCode: 'MIN', name: 'Inspection Générale des Formations', acronym: 'IGF', roleMapping: 'CENTRAL' as UserRole, requiresRegion: false, requiresDepartment: false, orderIndex: 4 },
    { code: 'SG', category: 'CENTRALE' as ServiceCategory, level: 1, parentCode: 'MIN', name: 'Secrétariat Général', acronym: 'SG', roleMapping: 'CENTRAL' as UserRole, requiresRegion: false, requiresDepartment: false, orderIndex: 5 },
    { code: 'DPE', category: 'CENTRALE' as ServiceCategory, level: 1, parentCode: 'MIN', name: "Division de la Promotion de l'Emploi", acronym: 'DPE', roleMapping: 'CENTRAL' as UserRole, requiresRegion: false, requiresDepartment: false, orderIndex: 6 },
    { code: 'DRMO', category: 'CENTRALE' as ServiceCategory, level: 1, parentCode: 'MIN', name: "Direction de la Régulation de la Main-d'Oeuvre", acronym: 'DRMO', roleMapping: 'CENTRAL' as UserRole, requiresRegion: false, requiresDepartment: false, orderIndex: 7 },
    { code: 'DFOP', category: 'CENTRALE' as ServiceCategory, level: 1, parentCode: 'MIN', name: "Direction de la Formation et de l'Orientation Professionnelles", acronym: 'DFOP', roleMapping: 'CENTRAL' as UserRole, requiresRegion: false, requiresDepartment: false, orderIndex: 8 },
    { code: 'DEPC', category: 'CENTRALE' as ServiceCategory, level: 1, parentCode: 'MIN', name: "Division des Études, de la Prospective et de la Coopération", acronym: 'DEPC', roleMapping: 'CENTRAL' as UserRole, requiresRegion: false, requiresDepartment: false, orderIndex: 9 },
    { code: 'DAG', category: 'CENTRALE' as ServiceCategory, level: 1, parentCode: 'MIN', name: 'Direction des Affaires Générales', acronym: 'DAG', roleMapping: 'CENTRAL' as UserRole, requiresRegion: false, requiresDepartment: false, orderIndex: 10 },

    // ══════════════════════════════════════════════════════════════════════════
    // SERVICES DECONCENTRES (Art. 61)
    // ══════════════════════════════════════════════════════════════════════════
    { code: 'DREFOP', category: 'DECONCENTRE' as ServiceCategory, level: 1, parentCode: 'MIN', name: "Délégation Régionale de l'Emploi et de la Formation Professionnelle", acronym: 'DREFOP', roleMapping: 'REGIONAL' as UserRole, requiresRegion: true, requiresDepartment: false, orderIndex: 100 },
    { code: 'DDEFOP', category: 'DECONCENTRE' as ServiceCategory, level: 1, parentCode: 'MIN', name: "Délégation Départementale de l'Emploi et de la Formation Professionnelle", acronym: 'DDEFOP', roleMapping: 'DIVISIONAL' as UserRole, requiresRegion: true, requiresDepartment: true, orderIndex: 101 },

    // ══════════════════════════════════════════════════════════════════════════
    // ORGANISMES RATTACHES (Art. 75)
    // ══════════════════════════════════════════════════════════════════════════
    { code: 'ONEFOP', category: 'RATTACHE' as ServiceCategory, level: 1, parentCode: 'MIN', name: "Observatoire National de l'Emploi et de la Formation Professionnelle", acronym: 'ONEFOP', roleMapping: 'CENTRAL' as UserRole, requiresRegion: false, requiresDepartment: false, orderIndex: 200 },
    { code: 'PIAASI', category: 'RATTACHE' as ServiceCategory, level: 1, parentCode: 'MIN', name: "Projet Intégré d'Appui aux Acteurs du Secteur Informel", acronym: 'PIAASI', roleMapping: 'CENTRAL' as UserRole, requiresRegion: false, requiresDepartment: false, orderIndex: 201 },
    { code: 'COSUP', category: 'RATTACHE' as ServiceCategory, level: 1, parentCode: 'MIN', name: "Centres d'Organisation Scolaire, Universitaire et Professionnelle", acronym: 'COSUP', roleMapping: 'CENTRAL' as UserRole, requiresRegion: false, requiresDepartment: false, orderIndex: 202 },

    // ══════════════════════════════════════════════════════════════════════════
    // SECRETARIAT GENERAL — Internal structure (Art. 10-24)
    // ══════════════════════════════════════════════════════════════════════════
    { code: 'SG-DAJ', category: 'CENTRALE' as ServiceCategory, level: 2, parentCode: 'SG', name: 'Division des Affaires Juridiques', acronym: 'DAJ', roleMapping: 'CENTRAL' as UserRole, requiresRegion: false, requiresDepartment: false, orderIndex: 20 },
    { code: 'SG-DAJ-CER', category: 'CENTRALE' as ServiceCategory, level: 3, parentCode: 'SG-DAJ', name: 'Cellule des Études et de la Réglementation', acronym: 'CER', roleMapping: 'CENTRAL' as UserRole, requiresRegion: false, requiresDepartment: false, orderIndex: 21 },
    { code: 'SG-DAJ-CC', category: 'CENTRALE' as ServiceCategory, level: 3, parentCode: 'SG-DAJ', name: 'Cellule du Contentieux', acronym: 'CC', roleMapping: 'CENTRAL' as UserRole, requiresRegion: false, requiresDepartment: false, orderIndex: 22 },
    { code: 'SG-CS', category: 'CENTRALE' as ServiceCategory, level: 2, parentCode: 'SG', name: 'Cellule de Suivi', acronym: 'CS', roleMapping: 'CENTRAL' as UserRole, requiresRegion: false, requiresDepartment: false, orderIndex: 23 },
    { code: 'SG-CC', category: 'CENTRALE' as ServiceCategory, level: 2, parentCode: 'SG', name: 'Cellule de Communication', acronym: 'CC', roleMapping: 'CENTRAL' as UserRole, requiresRegion: false, requiresDepartment: false, orderIndex: 24 },
    { code: 'SG-CI', category: 'CENTRALE' as ServiceCategory, level: 2, parentCode: 'SG', name: 'Cellule Informatique', acronym: 'CI', roleMapping: 'CENTRAL' as UserRole, requiresRegion: false, requiresDepartment: false, orderIndex: 25 },
    { code: 'SG-CT', category: 'CENTRALE' as ServiceCategory, level: 2, parentCode: 'SG', name: 'Cellule de Traduction', acronym: 'CT', roleMapping: 'CENTRAL' as UserRole, requiresRegion: false, requiresDepartment: false, orderIndex: 26 },
    { code: 'SG-SDACL', category: 'CENTRALE' as ServiceCategory, level: 2, parentCode: 'SG', name: "Sous-Direction de l'Accueil, du Courrier et de Liaison", acronym: 'SDACL', roleMapping: 'CENTRAL' as UserRole, requiresRegion: false, requiresDepartment: false, orderIndex: 27 },
    { code: 'SG-SDACL-SAO', category: 'CENTRALE' as ServiceCategory, level: 3, parentCode: 'SG-SDACL', name: "Service de l'Accueil et de l'Orientation", acronym: 'SAO', roleMapping: 'CENTRAL' as UserRole, requiresRegion: false, requiresDepartment: false, orderIndex: 28 },
    { code: 'SG-SDACL-SAO-BAI', category: 'CENTRALE' as ServiceCategory, level: 4, parentCode: 'SG-SDACL-SAO', name: "Bureau de l'Accueil et de l'Information", acronym: 'BAI', roleMapping: 'CENTRAL' as UserRole, requiresRegion: false, requiresDepartment: false, orderIndex: 29 },
    { code: 'SG-SDACL-SAO-BCC', category: 'CENTRALE' as ServiceCategory, level: 4, parentCode: 'SG-SDACL-SAO', name: "Bureau du Contrôle de Conformité", acronym: 'BCC', roleMapping: 'CENTRAL' as UserRole, requiresRegion: false, requiresDepartment: false, orderIndex: 30 },
    { code: 'SG-SDACL-SCL', category: 'CENTRALE' as ServiceCategory, level: 3, parentCode: 'SG-SDACL', name: "Service du Courrier et de Liaison", acronym: 'SCL', roleMapping: 'CENTRAL' as UserRole, requiresRegion: false, requiresDepartment: false, orderIndex: 31 },
    { code: 'SG-SDACL-SCL-BCA', category: 'CENTRALE' as ServiceCategory, level: 4, parentCode: 'SG-SDACL-SCL', name: "Bureau du Courrier « Arrivée »", acronym: 'BCA', roleMapping: 'CENTRAL' as UserRole, requiresRegion: false, requiresDepartment: false, orderIndex: 32 },
    { code: 'SG-SDACL-SCL-BCD', category: 'CENTRALE' as ServiceCategory, level: 4, parentCode: 'SG-SDACL-SCL', name: "Bureau du Courrier « Départ »", acronym: 'BCD', roleMapping: 'CENTRAL' as UserRole, requiresRegion: false, requiresDepartment: false, orderIndex: 33 },
    { code: 'SG-SDACL-SCL-BR', category: 'CENTRALE' as ServiceCategory, level: 4, parentCode: 'SG-SDACL-SCL', name: "Bureau de la Reprographie", acronym: 'BR', roleMapping: 'CENTRAL' as UserRole, requiresRegion: false, requiresDepartment: false, orderIndex: 34 },
    { code: 'SG-SDACL-SR', category: 'CENTRALE' as ServiceCategory, level: 3, parentCode: 'SG-SDACL', name: "Service de la Relance", acronym: 'SR', roleMapping: 'CENTRAL' as UserRole, requiresRegion: false, requiresDepartment: false, orderIndex: 35 },
    { code: 'SG-SDDA', category: 'CENTRALE' as ServiceCategory, level: 2, parentCode: 'SG', name: "Sous-Direction de la Documentation et des Archives", acronym: 'SDDA', roleMapping: 'CENTRAL' as UserRole, requiresRegion: false, requiresDepartment: false, orderIndex: 36 },
    { code: 'SG-SDDA-SD', category: 'CENTRALE' as ServiceCategory, level: 3, parentCode: 'SG-SDDA', name: "Service de la Documentation", acronym: 'SD', roleMapping: 'CENTRAL' as UserRole, requiresRegion: false, requiresDepartment: false, orderIndex: 37 },
    { code: 'SG-SDDA-SD-BRD', category: 'CENTRALE' as ServiceCategory, level: 4, parentCode: 'SG-SDDA-SD', name: "Bureau de la Reprographie et de la Diffusion", acronym: 'BRD', roleMapping: 'CENTRAL' as UserRole, requiresRegion: false, requiresDepartment: false, orderIndex: 38 },
    { code: 'SG-SDDA-SD-BDOC', category: 'CENTRALE' as ServiceCategory, level: 4, parentCode: 'SG-SDDA-SD', name: "Bureau de la Documentation", acronym: 'BDOC', roleMapping: 'CENTRAL' as UserRole, requiresRegion: false, requiresDepartment: false, orderIndex: 39 },
    { code: 'SG-SDDA-SA', category: 'CENTRALE' as ServiceCategory, level: 3, parentCode: 'SG-SDDA', name: "Service des Archives", acronym: 'SA', roleMapping: 'CENTRAL' as UserRole, requiresRegion: false, requiresDepartment: false, orderIndex: 40 },
    { code: 'SG-SDDA-SA-BC', category: 'CENTRALE' as ServiceCategory, level: 4, parentCode: 'SG-SDDA-SA', name: "Bureau du Classement", acronym: 'BC', roleMapping: 'CENTRAL' as UserRole, requiresRegion: false, requiresDepartment: false, orderIndex: 41 },
    { code: 'SG-SDDA-SA-BN', category: 'CENTRALE' as ServiceCategory, level: 4, parentCode: 'SG-SDDA-SA', name: "Bureau de la Numérique", acronym: 'BN', roleMapping: 'CENTRAL' as UserRole, requiresRegion: false, requiresDepartment: false, orderIndex: 42 },

    // ══════════════════════════════════════════════════════════════════════════
    // DPE — Internal structure (Art. 25-27)
    // ══════════════════════════════════════════════════════════════════════════
    { code: 'DPE-CPDE', category: 'CENTRALE' as ServiceCategory, level: 2, parentCode: 'DPE', name: "Cellule de la Planification et du Développement de l'Emploi", acronym: 'CPDE', roleMapping: 'CENTRAL' as UserRole, requiresRegion: false, requiresDepartment: false, orderIndex: 50 },
    { code: 'DPE-CLC', category: 'CENTRALE' as ServiceCategory, level: 2, parentCode: 'DPE', name: "Cellule de Lutte contre le Chômage", acronym: 'CLC', roleMapping: 'CENTRAL' as UserRole, requiresRegion: false, requiresDepartment: false, orderIndex: 51 },

    // ══════════════════════════════════════════════════════════════════════════
    // DRMO — Internal structure (Art. 28-35)
    // ══════════════════════════════════════════════════════════════════════════
    { code: 'DRMO-SDRPMO', category: 'CENTRALE' as ServiceCategory, level: 2, parentCode: 'DRMO', name: "Sous-Direction de la Réglementation et de la Planification de la Main-d'Oeuvre", acronym: 'SDRPMO', roleMapping: 'CENTRAL' as UserRole, requiresRegion: false, requiresDepartment: false, orderIndex: 60 },
    { code: 'DRMO-SDRPMO-SRMO', category: 'CENTRALE' as ServiceCategory, level: 3, parentCode: 'DRMO-SDRPMO', name: "Service de la Réglementation de la Main-d'Oeuvre", acronym: 'SRMO', roleMapping: 'CENTRAL' as UserRole, requiresRegion: false, requiresDepartment: false, orderIndex: 61 },
    { code: 'DRMO-SDRPMO-SSPMO', category: 'CENTRALE' as ServiceCategory, level: 3, parentCode: 'DRMO-SDRPMO', name: "Service des Statistiques et de la Planification de la Main-d'Oeuvre", acronym: 'SSPMO', roleMapping: 'CENTRAL' as UserRole, requiresRegion: false, requiresDepartment: false, orderIndex: 62 },
    { code: 'DRMO-SDRPMO-SSPMO-BF', category: 'CENTRALE' as ServiceCategory, level: 4, parentCode: 'DRMO-SDRPMO-SSPMO', name: "Bureau des Fichiers", acronym: 'BF', roleMapping: 'CENTRAL' as UserRole, requiresRegion: false, requiresDepartment: false, orderIndex: 63 },
    { code: 'DRMO-SDRPMO-SSPMO-BSP', category: 'CENTRALE' as ServiceCategory, level: 4, parentCode: 'DRMO-SDRPMO-SSPMO', name: "Bureau des Statistiques et de la Planification", acronym: 'BSP', roleMapping: 'CENTRAL' as UserRole, requiresRegion: false, requiresDepartment: false, orderIndex: 64 },
    { code: 'DRMO-SDIA', category: 'CENTRALE' as ServiceCategory, level: 2, parentCode: 'DRMO', name: "Sous-Direction de l'Insertion et des Agréments", acronym: 'SDIA', roleMapping: 'CENTRAL' as UserRole, requiresRegion: false, requiresDepartment: false, orderIndex: 65 },
    { code: 'DRMO-SDIA-SI', category: 'CENTRALE' as ServiceCategory, level: 3, parentCode: 'DRMO-SDIA', name: "Service de l'Insertion", acronym: 'SI', roleMapping: 'CENTRAL' as UserRole, requiresRegion: false, requiresDepartment: false, orderIndex: 66 },
    { code: 'DRMO-SDIA-SI-BCDCE', category: 'CENTRALE' as ServiceCategory, level: 4, parentCode: 'DRMO-SDIA-SI', name: "Bureau de Centralisation des Données sur les Chercheurs d'Emplois", acronym: 'BCDCE', roleMapping: 'CENTRAL' as UserRole, requiresRegion: false, requiresDepartment: false, orderIndex: 67 },
    { code: 'DRMO-SDIA-SI-BPOE', category: 'CENTRALE' as ServiceCategory, level: 4, parentCode: 'DRMO-SDIA-SI', name: "Bureau de Prospection des Opportunités d'Emplois", acronym: 'BPOE', roleMapping: 'CENTRAL' as UserRole, requiresRegion: false, requiresDepartment: false, orderIndex: 68 },
    { code: 'DRMO-SDIA-SC', category: 'CENTRALE' as ServiceCategory, level: 3, parentCode: 'DRMO-SDIA', name: "Service des Contrats", acronym: 'SC', roleMapping: 'CENTRAL' as UserRole, requiresRegion: false, requiresDepartment: false, orderIndex: 69 },
    { code: 'DRMO-SDIA-SC-BCTN', category: 'CENTRALE' as ServiceCategory, level: 4, parentCode: 'DRMO-SDIA-SC', name: "Bureau des Contrats de Travail des Nationaux", acronym: 'BCTN', roleMapping: 'CENTRAL' as UserRole, requiresRegion: false, requiresDepartment: false, orderIndex: 70 },
    { code: 'DRMO-SDIA-SC-BCTE', category: 'CENTRALE' as ServiceCategory, level: 4, parentCode: 'DRMO-SDIA-SC', name: "Bureau des Contrats de Travail des Expatriés", acronym: 'BCTE', roleMapping: 'CENTRAL' as UserRole, requiresRegion: false, requiresDepartment: false, orderIndex: 71 },
    { code: 'DRMO-SDIA-SAC', category: 'CENTRALE' as ServiceCategory, level: 3, parentCode: 'DRMO-SDIA', name: "Service des Agréments et des Contrôles", acronym: 'SAC', roleMapping: 'CENTRAL' as UserRole, requiresRegion: false, requiresDepartment: false, orderIndex: 72 },
    { code: 'DRMO-SDIA-SAC-BA', category: 'CENTRALE' as ServiceCategory, level: 4, parentCode: 'DRMO-SDIA-SAC', name: "Bureau des Agréments", acronym: 'BA', roleMapping: 'CENTRAL' as UserRole, requiresRegion: false, requiresDepartment: false, orderIndex: 73 },
    { code: 'DRMO-SDIA-SAC-BSA', category: 'CENTRALE' as ServiceCategory, level: 4, parentCode: 'DRMO-SDIA-SAC', name: "Bureau du Suivi des Activités", acronym: 'BSA', roleMapping: 'CENTRAL' as UserRole, requiresRegion: false, requiresDepartment: false, orderIndex: 74 },

    // ══════════════════════════════════════════════════════════════════════════
    // DFOP — Internal structure (Art. 36-45)
    // ══════════════════════════════════════════════════════════════════════════
    { code: 'DFOP-SDGSF', category: 'CENTRALE' as ServiceCategory, level: 2, parentCode: 'DFOP', name: "Sous-Direction de la Gestion des Structures de Formation", acronym: 'SDGSF', roleMapping: 'CENTRAL' as UserRole, requiresRegion: false, requiresDepartment: false, orderIndex: 80 },
    { code: 'DFOP-SDGSF-SSFPA', category: 'CENTRALE' as ServiceCategory, level: 3, parentCode: 'DFOP-SDGSF', name: "Service de Suivi des Structures de Formation Professionnelle", acronym: 'SSFPA', roleMapping: 'CENTRAL' as UserRole, requiresRegion: false, requiresDepartment: false, orderIndex: 81 },
    { code: 'DFOP-SDGSF-SSFPA-BSSPP', category: 'CENTRALE' as ServiceCategory, level: 4, parentCode: 'DFOP-SDGSF-SSFPA', name: "Bureau du Suivi des Structures Publiques et Privées de Formation Professionnelle", acronym: 'BSSPP', roleMapping: 'CENTRAL' as UserRole, requiresRegion: false, requiresDepartment: false, orderIndex: 82 },
    { code: 'DFOP-SDGSF-SSFPA-BSSS', category: 'CENTRALE' as ServiceCategory, level: 4, parentCode: 'DFOP-SDGSF-SSFPA', name: "Bureau du Suivi des Structures Spécialisées de Formation Professionnelle", acronym: 'BSSS', roleMapping: 'CENTRAL' as UserRole, requiresRegion: false, requiresDepartment: false, orderIndex: 83 },
    { code: 'DFOP-SDGSF-SACD', category: 'CENTRALE' as ServiceCategory, level: 3, parentCode: 'DFOP-SDGSF', name: "Service des Agréments, du Contrôle et de la Diffusion", acronym: 'SACD', roleMapping: 'CENTRAL' as UserRole, requiresRegion: false, requiresDepartment: false, orderIndex: 84 },
    { code: 'DFOP-SDGSF-SACD-BCA', category: 'CENTRALE' as ServiceCategory, level: 4, parentCode: 'DFOP-SDGSF-SACD', name: "Bureau du Contrôle et d'Agrément des structures privées de formation professionnelle", acronym: 'BCA', roleMapping: 'CENTRAL' as UserRole, requiresRegion: false, requiresDepartment: false, orderIndex: 85 },
    { code: 'DFOP-SDGSF-SACD-BDDA', category: 'CENTRALE' as ServiceCategory, level: 4, parentCode: 'DFOP-SDGSF-SACD', name: "Bureau de la Diffusion, de la Documentation et des Archives", acronym: 'BDDA', roleMapping: 'CENTRAL' as UserRole, requiresRegion: false, requiresDepartment: false, orderIndex: 86 },
    { code: 'DFOP-SDECC', category: 'CENTRALE' as ServiceCategory, level: 2, parentCode: 'DFOP', name: "Sous-Direction des Examens, des Concours et de la Certification", acronym: 'SDECC', roleMapping: 'CENTRAL' as UserRole, requiresRegion: false, requiresDepartment: false, orderIndex: 87 },
    { code: 'DFOP-SDECC-SOEC', category: 'CENTRALE' as ServiceCategory, level: 3, parentCode: 'DFOP-SDECC', name: "Service de l'Organisation des Examens et Concours", acronym: 'SOEC', roleMapping: 'CENTRAL' as UserRole, requiresRegion: false, requiresDepartment: false, orderIndex: 88 },
    { code: 'DFOP-SDECC-SOEC-BOEC', category: 'CENTRALE' as ServiceCategory, level: 4, parentCode: 'DFOP-SDECC-SOEC', name: "Bureau de l'Organisation des Examens et Concours", acronym: 'BOEC', roleMapping: 'CENTRAL' as UserRole, requiresRegion: false, requiresDepartment: false, orderIndex: 89 },
    { code: 'DFOP-SDECC-SOEC-BMR', category: 'CENTRALE' as ServiceCategory, level: 4, parentCode: 'DFOP-SDECC-SOEC', name: "Bureau du Matériel et de la Reprographie", acronym: 'BMR', roleMapping: 'CENTRAL' as UserRole, requiresRegion: false, requiresDepartment: false, orderIndex: 90 },
    { code: 'DFOP-SDECC-SCAS', category: 'CENTRALE' as ServiceCategory, level: 3, parentCode: 'DFOP-SDECC', name: "Service de la Certification, des Archives et des Statistiques", acronym: 'SCAS', roleMapping: 'CENTRAL' as UserRole, requiresRegion: false, requiresDepartment: false, orderIndex: 91 },
    { code: 'DFOP-SDECC-SCAS-BC', category: 'CENTRALE' as ServiceCategory, level: 4, parentCode: 'DFOP-SDECC-SCAS', name: "Bureau de la Certification", acronym: 'BC', roleMapping: 'CENTRAL' as UserRole, requiresRegion: false, requiresDepartment: false, orderIndex: 92 },
    { code: 'DFOP-SDECC-SCAS-BAS', category: 'CENTRALE' as ServiceCategory, level: 4, parentCode: 'DFOP-SDECC-SCAS', name: "Bureau des Archives et des Statistiques", acronym: 'BAS', roleMapping: 'CENTRAL' as UserRole, requiresRegion: false, requiresDepartment: false, orderIndex: 93 },
    { code: 'DFOP-SDOP', category: 'CENTRALE' as ServiceCategory, level: 2, parentCode: 'DFOP', name: "Sous-Direction de l'Orientation Professionnelle", acronym: 'SDOP', roleMapping: 'CENTRAL' as UserRole, requiresRegion: false, requiresDepartment: false, orderIndex: 94 },
    { code: 'DFOP-SDOP-SOP', category: 'CENTRALE' as ServiceCategory, level: 3, parentCode: 'DFOP-SDOP', name: "Service de l'Orientation Professionnelle", acronym: 'SOP', roleMapping: 'CENTRAL' as UserRole, requiresRegion: false, requiresDepartment: false, orderIndex: 95 },
    { code: 'DFOP-SDOP-SOP-BOIP', category: 'CENTRALE' as ServiceCategory, level: 4, parentCode: 'DFOP-SDOP-SOP', name: "Bureau de l'Orientation, de l'Information et de la Production", acronym: 'BOIP', roleMapping: 'CENTRAL' as UserRole, requiresRegion: false, requiresDepartment: false, orderIndex: 96 },
    { code: 'DFOP-SDOP-SOP-BSA', category: 'CENTRALE' as ServiceCategory, level: 4, parentCode: 'DFOP-SDOP-SOP', name: "Bureau des Statistiques et des Archives", acronym: 'BSA', roleMapping: 'CENTRAL' as UserRole, requiresRegion: false, requiresDepartment: false, orderIndex: 97 },
    { code: 'DFOP-SDOP-SRP', category: 'CENTRALE' as ServiceCategory, level: 3, parentCode: 'DFOP-SDOP', name: "Service du Reclassement Professionnel", acronym: 'SRP', roleMapping: 'CENTRAL' as UserRole, requiresRegion: false, requiresDepartment: false, orderIndex: 98 },
    { code: 'DFOP-SDOP-SRP-BRP', category: 'CENTRALE' as ServiceCategory, level: 4, parentCode: 'DFOP-SDOP-SRP', name: "Bureau de la Réglementation Psychotechnique", acronym: 'BRP', roleMapping: 'CENTRAL' as UserRole, requiresRegion: false, requiresDepartment: false, orderIndex: 99 },
    { code: 'DFOP-SDOP-SRP-BARP', category: 'CENTRALE' as ServiceCategory, level: 4, parentCode: 'DFOP-SDOP-SRP', name: "Bureau des Agréments et des Reclassements Professionnels", acronym: 'BARP', roleMapping: 'CENTRAL' as UserRole, requiresRegion: false, requiresDepartment: false, orderIndex: 100 },

    // ══════════════════════════════════════════════════════════════════════════
    // DEPC — Internal structure (Art. 46-48)
    // ══════════════════════════════════════════════════════════════════════════
    { code: 'DEPC-CEPS', category: 'CENTRALE' as ServiceCategory, level: 2, parentCode: 'DEPC', name: "Cellule des Études, de la Prospective et des Statistiques", acronym: 'CEPS', roleMapping: 'CENTRAL' as UserRole, requiresRegion: false, requiresDepartment: false, orderIndex: 110 },
    { code: 'DEPC-CC', category: 'CENTRALE' as ServiceCategory, level: 2, parentCode: 'DEPC', name: "Cellule de la Coopération", acronym: 'CC', roleMapping: 'CENTRAL' as UserRole, requiresRegion: false, requiresDepartment: false, orderIndex: 111 },

    // ══════════════════════════════════════════════════════════════════════════
    // DAG — Internal structure (Art. 49-60)
    // ══════════════════════════════════════════════════════════════════════════
    { code: 'DAG-CSIGIPES', category: 'CENTRALE' as ServiceCategory, level: 2, parentCode: 'DAG', name: "Cellule de Gestion du Projet SIGIPES", acronym: 'CSIGIPES', roleMapping: 'CENTRAL' as UserRole, requiresRegion: false, requiresDepartment: false, orderIndex: 120 },
    { code: 'DAG-SDPSP', category: 'CENTRALE' as ServiceCategory, level: 2, parentCode: 'DAG', name: "Sous-Direction du Personnel, de la Solde et des Pensions", acronym: 'SDPSP', roleMapping: 'CENTRAL' as UserRole, requiresRegion: false, requiresDepartment: false, orderIndex: 121 },
    { code: 'DAG-SDPSP-SPFC', category: 'CENTRALE' as ServiceCategory, level: 3, parentCode: 'DAG-SDPSP', name: "Service du Personnel et de la Formation Continue", acronym: 'SPFC', roleMapping: 'CENTRAL' as UserRole, requiresRegion: false, requiresDepartment: false, orderIndex: 122 },
    { code: 'DAG-SDPSP-SPFC-BPF', category: 'CENTRALE' as ServiceCategory, level: 4, parentCode: 'DAG-SDPSP-SPFC', name: "Bureau du Personnel Fonctionnaire", acronym: 'BPF', roleMapping: 'CENTRAL' as UserRole, requiresRegion: false, requiresDepartment: false, orderIndex: 123 },
    { code: 'DAG-SDPSP-SPFC-BPNF', category: 'CENTRALE' as ServiceCategory, level: 4, parentCode: 'DAG-SDPSP-SPFC', name: "Bureau du Personnel non Fonctionnaire", acronym: 'BPNF', roleMapping: 'CENTRAL' as UserRole, requiresRegion: false, requiresDepartment: false, orderIndex: 124 },
    { code: 'DAG-SDPSP-SPFC-BFC', category: 'CENTRALE' as ServiceCategory, level: 4, parentCode: 'DAG-SDPSP-SPFC', name: "Bureau de la Formation Continue", acronym: 'BFC', roleMapping: 'CENTRAL' as UserRole, requiresRegion: false, requiresDepartment: false, orderIndex: 125 },
    { code: 'DAG-SDPSP-SPFC-BGPE', category: 'CENTRALE' as ServiceCategory, level: 4, parentCode: 'DAG-SDPSP-SPFC', name: "Bureau de la Gestion Prévisionnelle des Effectifs", acronym: 'BGPE', roleMapping: 'CENTRAL' as UserRole, requiresRegion: false, requiresDepartment: false, orderIndex: 126 },
    { code: 'DAG-SDPSP-SSP', category: 'CENTRALE' as ServiceCategory, level: 3, parentCode: 'DAG-SDPSP', name: "Service de la Solde et des Pensions", acronym: 'SSP', roleMapping: 'CENTRAL' as UserRole, requiresRegion: false, requiresDepartment: false, orderIndex: 127 },
    { code: 'DAG-SDPSP-SSP-BSPD', category: 'CENTRALE' as ServiceCategory, level: 4, parentCode: 'DAG-SDPSP-SSP', name: "Bureau de la Solde et des Prestations Diverses", acronym: 'BSPD', roleMapping: 'CENTRAL' as UserRole, requiresRegion: false, requiresDepartment: false, orderIndex: 128 },
    { code: 'DAG-SDPSP-SSP-BP', category: 'CENTRALE' as ServiceCategory, level: 4, parentCode: 'DAG-SDPSP-SSP', name: "Bureau des Pensions", acronym: 'BP', roleMapping: 'CENTRAL' as UserRole, requiresRegion: false, requiresDepartment: false, orderIndex: 129 },
    { code: 'DAG-SDPSP-SAS', category: 'CENTRALE' as ServiceCategory, level: 3, parentCode: 'DAG-SDPSP', name: "Service de l'Action Sociale", acronym: 'SAS', roleMapping: 'CENTRAL' as UserRole, requiresRegion: false, requiresDepartment: false, orderIndex: 130 },
    { code: 'DAG-SDB', category: 'CENTRALE' as ServiceCategory, level: 2, parentCode: 'DAG', name: "Sous-Direction du Budget", acronym: 'SDB', roleMapping: 'CENTRAL' as UserRole, requiresRegion: false, requiresDepartment: false, orderIndex: 131 },
    { code: 'DAG-SDB-SB', category: 'CENTRALE' as ServiceCategory, level: 3, parentCode: 'DAG-SDB', name: "Service du Budget", acronym: 'SB', roleMapping: 'CENTRAL' as UserRole, requiresRegion: false, requiresDepartment: false, orderIndex: 132 },
    { code: 'DAG-SDB-SB-BPB', category: 'CENTRALE' as ServiceCategory, level: 4, parentCode: 'DAG-SDB-SB', name: "Bureau de la Préparation du Budget", acronym: 'BPB', roleMapping: 'CENTRAL' as UserRole, requiresRegion: false, requiresDepartment: false, orderIndex: 133 },
    { code: 'DAG-SDB-SB-BSEB', category: 'CENTRALE' as ServiceCategory, level: 4, parentCode: 'DAG-SDB-SB', name: "Bureau du Suivi de l'exécution du Budget", acronym: 'BSEB', roleMapping: 'CENTRAL' as UserRole, requiresRegion: false, requiresDepartment: false, orderIndex: 134 },
    { code: 'DAG-SDB-SMP', category: 'CENTRALE' as ServiceCategory, level: 3, parentCode: 'DAG-SDB', name: "Service des Marchés Publics", acronym: 'SMP', roleMapping: 'CENTRAL' as UserRole, requiresRegion: false, requiresDepartment: false, orderIndex: 135 },
    { code: 'DAG-SDB-SMP-BAO', category: 'CENTRALE' as ServiceCategory, level: 4, parentCode: 'DAG-SDB-SMP', name: "Bureau des Appels d'Offre", acronym: 'BAO', roleMapping: 'CENTRAL' as UserRole, requiresRegion: false, requiresDepartment: false, orderIndex: 136 },
    { code: 'DAG-SDB-SMP-BSCEM', category: 'CENTRALE' as ServiceCategory, level: 4, parentCode: 'DAG-SDB-SMP', name: "Bureau du Suivi et du Contrôle de l'Exécution des Marchés", acronym: 'BSCEM', roleMapping: 'CENTRAL' as UserRole, requiresRegion: false, requiresDepartment: false, orderIndex: 137 },
    { code: 'DAG-SDIEM', category: 'CENTRALE' as ServiceCategory, level: 2, parentCode: 'DAG', name: "Sous-Direction des Infrastructures, des Equipements et de la Maintenance", acronym: 'SDIEM', roleMapping: 'CENTRAL' as UserRole, requiresRegion: false, requiresDepartment: false, orderIndex: 138 },
    { code: 'DAG-SDIEM-SNC', category: 'CENTRALE' as ServiceCategory, level: 3, parentCode: 'DAG-SDIEM', name: "Service des Normes de Construction", acronym: 'SNC', roleMapping: 'CENTRAL' as UserRole, requiresRegion: false, requiresDepartment: false, orderIndex: 139 },
    { code: 'DAG-SDIEM-SMEM', category: 'CENTRALE' as ServiceCategory, level: 3, parentCode: 'DAG-SDIEM', name: "Service du Matériel, des Equipements et de la Maintenance", acronym: 'SMEM', roleMapping: 'CENTRAL' as UserRole, requiresRegion: false, requiresDepartment: false, orderIndex: 140 },

    // ══════════════════════════════════════════════════════════════════════════
    // DREFOP — Internal structure (Art. 62-68)
    // ══════════════════════════════════════════════════════════════════════════
    { code: 'DREFOP-IRF', category: 'DECONCENTRE' as ServiceCategory, level: 2, parentCode: 'DREFOP', name: "Inspection Régionale des Formations", acronym: 'IRF', roleMapping: 'REGIONAL' as UserRole, requiresRegion: true, requiresDepartment: false, orderIndex: 200 },
    { code: 'DREFOP-SPE', category: 'DECONCENTRE' as ServiceCategory, level: 2, parentCode: 'DREFOP', name: "Service de la Promotion de l'Emploi", acronym: 'SPE', roleMapping: 'REGIONAL' as UserRole, requiresRegion: true, requiresDepartment: false, orderIndex: 201 },
    { code: 'DREFOP-SPE-BAE', category: 'DECONCENTRE' as ServiceCategory, level: 3, parentCode: 'DREFOP-SPE', name: "Bureau de la promotion de l'auto emploi", acronym: 'BAE', roleMapping: 'REGIONAL' as UserRole, requiresRegion: true, requiresDepartment: false, orderIndex: 202 },
    { code: 'DREFOP-SPE-BHIMO', category: 'DECONCENTRE' as ServiceCategory, level: 3, parentCode: 'DREFOP-SPE', name: "Bureau de la promotion de l'approche HIMO", acronym: 'BHIMO', roleMapping: 'REGIONAL' as UserRole, requiresRegion: true, requiresDepartment: false, orderIndex: 203 },
    { code: 'DREFOP-SPE-BMISF', category: 'DECONCENTRE' as ServiceCategory, level: 3, parentCode: 'DREFOP-SPE', name: "Bureau de Migration du secteur Informel vers le secteur formel", acronym: 'BMISF', roleMapping: 'REGIONAL' as UserRole, requiresRegion: true, requiresDepartment: false, orderIndex: 204 },
    { code: 'DREFOP-SRMO', category: 'DECONCENTRE' as ServiceCategory, level: 2, parentCode: 'DREFOP', name: "Service de la Régulation de la Main-d'Oeuvre", acronym: 'SRMO', roleMapping: 'REGIONAL' as UserRole, requiresRegion: true, requiresDepartment: false, orderIndex: 205 },
    { code: 'DREFOP-SRMO-BEP', category: 'DECONCENTRE' as ServiceCategory, level: 3, parentCode: 'DREFOP-SRMO', name: "Bureau de l'enregistrement et du placement", acronym: 'BEP', roleMapping: 'REGIONAL' as UserRole, requiresRegion: true, requiresDepartment: false, orderIndex: 206 },
    { code: 'DREFOP-SRMO-BFS', category: 'DECONCENTRE' as ServiceCategory, level: 3, parentCode: 'DREFOP-SRMO', name: "Bureau du fichier et des statistiques", acronym: 'BFS', roleMapping: 'REGIONAL' as UserRole, requiresRegion: true, requiresDepartment: false, orderIndex: 207 },
    { code: 'DREFOP-SFOP', category: 'DECONCENTRE' as ServiceCategory, level: 2, parentCode: 'DREFOP', name: "Service de la Formation et de l'Orientation Professionnelle", acronym: 'SFOP', roleMapping: 'REGIONAL' as UserRole, requiresRegion: true, requiresDepartment: false, orderIndex: 208 },
    { code: 'DREFOP-SFOP-BGSF', category: 'DECONCENTRE' as ServiceCategory, level: 3, parentCode: 'DREFOP-SFOP', name: "Bureau de gestion des structures de formation professionnelle", acronym: 'BGSF', roleMapping: 'REGIONAL' as UserRole, requiresRegion: true, requiresDepartment: false, orderIndex: 209 },
    { code: 'DREFOP-SFOP-BE', category: 'DECONCENTRE' as ServiceCategory, level: 3, parentCode: 'DREFOP-SFOP', name: "Bureau des Evaluations", acronym: 'BE', roleMapping: 'REGIONAL' as UserRole, requiresRegion: true, requiresDepartment: false, orderIndex: 210 },
    { code: 'DREFOP-SFOP-BOTP', category: 'DECONCENTRE' as ServiceCategory, level: 3, parentCode: 'DREFOP-SFOP', name: "Bureau de l'Orientation, des tests psychotechniques et du contrôle des conditions psychologiques du travail", acronym: 'BOTP', roleMapping: 'REGIONAL' as UserRole, requiresRegion: true, requiresDepartment: false, orderIndex: 211 },
    { code: 'DREFOP-SAF', category: 'DECONCENTRE' as ServiceCategory, level: 2, parentCode: 'DREFOP', name: "Service Administratif et Financier", acronym: 'SAF', roleMapping: 'REGIONAL' as UserRole, requiresRegion: true, requiresDepartment: false, orderIndex: 212 },
    { code: 'DREFOP-SAF-BP', category: 'DECONCENTRE' as ServiceCategory, level: 3, parentCode: 'DREFOP-SAF', name: "Bureau du personnel", acronym: 'BP', roleMapping: 'REGIONAL' as UserRole, requiresRegion: true, requiresDepartment: false, orderIndex: 213 },
    { code: 'DREFOP-SAF-BBM', category: 'DECONCENTRE' as ServiceCategory, level: 3, parentCode: 'DREFOP-SAF', name: "Bureau du budget et du Matériel", acronym: 'BBM', roleMapping: 'REGIONAL' as UserRole, requiresRegion: true, requiresDepartment: false, orderIndex: 214 },
    { code: 'DREFOP-BACL', category: 'DECONCENTRE' as ServiceCategory, level: 2, parentCode: 'DREFOP', name: "Bureau de l'Accueil, du Courrier et de Liaison", acronym: 'BACL', roleMapping: 'REGIONAL' as UserRole, requiresRegion: true, requiresDepartment: false, orderIndex: 215 },

    // ══════════════════════════════════════════════════════════════════════════
    // DDEFOP — Internal structure (Art. 69-73)
    // ══════════════════════════════════════════════════════════════════════════
    { code: 'DDEFOP-SLSCJ', category: 'DECONCENTRE' as ServiceCategory, level: 2, parentCode: 'DDEFOP', name: "Service de lutte contre le sous-emploi et le chômage des jeunes", acronym: 'SLSCJ', roleMapping: 'DIVISIONAL' as UserRole, requiresRegion: true, requiresDepartment: true, orderIndex: 300 },
    { code: 'DDEFOP-SLSCJ-BES', category: 'DECONCENTRE' as ServiceCategory, level: 3, parentCode: 'DDEFOP-SLSCJ', name: "Bureau de l'emploi Salarié", acronym: 'BES', roleMapping: 'DIVISIONAL' as UserRole, requiresRegion: true, requiresDepartment: true, orderIndex: 301 },
    { code: 'DDEFOP-SLSCJ-BEI', category: 'DECONCENTRE' as ServiceCategory, level: 3, parentCode: 'DDEFOP-SLSCJ', name: "Bureau de l'emploi Indépendant", acronym: 'BEI', roleMapping: 'DIVISIONAL' as UserRole, requiresRegion: true, requiresDepartment: true, orderIndex: 302 },
    { code: 'DDEFOP-SLSCJ-BCS', category: 'DECONCENTRE' as ServiceCategory, level: 3, parentCode: 'DDEFOP-SLSCJ', name: "Bureau des contrôles et des statistiques", acronym: 'BCS', roleMapping: 'DIVISIONAL' as UserRole, requiresRegion: true, requiresDepartment: true, orderIndex: 303 },
    { code: 'DDEFOP-SFOE', category: 'DECONCENTRE' as ServiceCategory, level: 2, parentCode: 'DDEFOP', name: "Service de la formation, de l'orientation professionnelle et des évaluations", acronym: 'SFOE', roleMapping: 'DIVISIONAL' as UserRole, requiresRegion: true, requiresDepartment: true, orderIndex: 304 },
    { code: 'DDEFOP-SFOE-BACE', category: 'DECONCENTRE' as ServiceCategory, level: 3, parentCode: 'DDEFOP-SFOE', name: "Bureau de l'accueil des chercheurs d'emploi", acronym: 'BACE', roleMapping: 'DIVISIONAL' as UserRole, requiresRegion: true, requiresDepartment: true, orderIndex: 305 },
    { code: 'DDEFOP-SFOE-BOP', category: 'DECONCENTRE' as ServiceCategory, level: 3, parentCode: 'DDEFOP-SFOE', name: "Bureau de l'orientation professionnelle", acronym: 'BOP', roleMapping: 'DIVISIONAL' as UserRole, requiresRegion: true, requiresDepartment: true, orderIndex: 306 },
    { code: 'DDEFOP-SFOE-BGSF', category: 'DECONCENTRE' as ServiceCategory, level: 3, parentCode: 'DDEFOP-SFOE', name: "Bureau de la gestion des structures de formation", acronym: 'BGSF', roleMapping: 'DIVISIONAL' as UserRole, requiresRegion: true, requiresDepartment: true, orderIndex: 307 },
    { code: 'DDEFOP-BAG', category: 'DECONCENTRE' as ServiceCategory, level: 2, parentCode: 'DDEFOP', name: "Bureau des Affaires Générales", acronym: 'BAG', roleMapping: 'DIVISIONAL' as UserRole, requiresRegion: true, requiresDepartment: true, orderIndex: 308 },
    { code: 'DDEFOP-BACL', category: 'DECONCENTRE' as ServiceCategory, level: 2, parentCode: 'DDEFOP', name: "Bureau de l'Accueil, du Courrier et de Liaison", acronym: 'BACL', roleMapping: 'DIVISIONAL' as UserRole, requiresRegion: true, requiresDepartment: true, orderIndex: 309 },
];

// ============================================================
// SERVICE POSITIONS (Art. 1-73)
// ============================================================
const servicePositions: {
    ...
    orderIndex: number;
        ...
        // MINISTRE (Art. 1)
        // ══════════════════════════════════════════════════════════════════════════
        { serviceCode: 'MIN', positionType: 'MINISTRE', title: 'Ministre de l\'Emploi et de la Formation Professionnelle', titleEn: 'Minister of Employment and Vocational Training', level: 1, orderIndex: 1 },

        // ══════════════════════════════════════════════════════════════════════════
        // SECRETARIAT PARTICULIER (Art. 3)
        // ══════════════════════════════════════════════════════════════════════════
        ...
        // ══════════════════════════════════════════════════════════════════════════
        // INSPECTION GENERALE DES SERVICES (Art. 5)
        // ══════════════════════════════════════════════════════════════════════════
        ...
        // ══════════════════════════════════════════════════════════════════════════
        // INSPECTION GENERALE DES FORMATIONS (Art. 7)
        // ══════════════════════════════════════════════════════════════════════════
        ...
        // Cellule des Études et de la Réglementation (Art. 12)
        ...
        // Cellule de Communication (Art. 15)
        ...
        // Sous-Direction Accueil, Courrier, Liaison (Art. 18)
        ...
        // Service de l'Accueil et de l'Orientation (Art. 19)
        ...
        // Service du Courrier et de Liaison (Art. 20)
        ...
        // Sous-Direction Documentation et Archives (Art. 22)
        ...
        // Service de la Documentation (Art. 23)
        ...
        // ══════════════════════════════════════════════════════════════════════════
        // DIVISION DE LA PROMOTION DE L'EMPLOI (Art. 25)
        // ══════════════════════════════════════════════════════════════════════════
        ...
        // Cellule Planification et Développement Emploi (Art. 26)
        ...
        // Cellule Lutte contre Chômage (Art. 27)
        ...
        // ══════════════════════════════════════════════════════════════════════════
        // DIRECTION DE LA REGULATION DE LA MAIN-D'OEUVRE (Art. 28)
        // ══════════════════════════════════════════════════════════════════════════
        ...
        // SD Réglementation et Planification (Art. 29)
        ...
        // SD Insertion et Agréments (Art. 32)
        ...
        // ══════════════════════════════════════════════════════════════════════════
        // DIRECTION DE LA FORMATION ET DE L'ORIENTATION PROFESSIONNELLES (Art. 36)
        // ══════════════════════════════════════════════════════════════════════════
        ...
        // ══════════════════════════════════════════════════════════════════════════
        // DIVISION DES ETUDES, PROSPECTIVE ET COOPERATION (Art. 46)
        // ══════════════════════════════════════════════════════════════════════════
        ...
        // ══════════════════════════════════════════════════════════════════════════
        // DIRECTION DES AFFAIRES GENERALES (Art. 49)
        // ══════════════════════════════════════════════════════════════════════════
...
/// ============================================================
// SEED FUNCTION (Idempotent - can run multiple times)
// ============================================================
async function seed() {
    console.log('🌱 Starting MINEFOP seed (Décret 2012)...\n');
    ...
    try {
        ...
        for (const s of minefopServices) {
            ...
            serviceCount++;
            if (serviceCount % 30 === 0) console.log(`   ... ${serviceCount}/${minefopServices.length} services processed`);
        }
        console.log(`   ✅ ${minefopServices.length} services (existing skipped)`);
        ...
        for (const pos of servicePositions) {
            await withRetry(async () => {
                ...
                if (!exists) {
                    await prisma.servicePosition.create({
                        data: pos,
                    });
                    posCreated++;
                }
            });
            if (posCreated % 30 === 0) console.log(`   ... ${posCreated} new positions created`);
        }
        console.log(`   ✅ ${posCreated} new positions created (${servicePositions.length - posCreated} already existed)`);
        ...
        // ── TEST USERS (skip if exist) ───────────────────────────────────────────
        console.log('👥 Creating test users...');

        const testUsers = [
            { email: 'minister@minefop.cm', firstName: 'Paul', lastName: 'Biya', role: 'CENTRAL', serviceCode: 'MIN', positionType: 'MINISTRE' },
            { email: 'regional.centre@minefop.cm', firstName: 'Jean', lastName: 'Nkuéta', role: 'REGIONAL', region: 'Centre', serviceCode: 'DREFOP', positionType: 'DELEGUE_REGIONAL' },
            { email: 'divisional.mfoundi@minefop.cm', firstName: 'Marie', lastName: 'Ebanda', role: 'DIVISIONAL', region: 'Centre', department: 'Mfoundi', serviceCode: 'DDEFOP', positionType: 'DELEGUE_DEPARTEMENTAL' },
        ];
        ...
        // ── SAMPLE COMPANIES (optional, skip if exist) ──────────────────────────
        ...
        for (let i = 1; i <= 20; i++) {
            ...
            if (i % 5 === 0) console.log(`   ... ${i} companies processed`);
        }
        ...
        console.log(`\n🏛️  Services: ${minefopServices.length}  |  Positions: ${servicePositions.length}`);
